...
public class OrderDetailsActivity extends BaseActivity {
	...
	public void initPostData(){
		DialogUtil.getInstance(OrderDetailsActivity.this).startProgressDialog(
				OrderDetailsActivity.this, "");
		String jsonData = InitJson.getInstance(OrderDetailsActivity.this)
				.initDetailOrder("cs.trade.single.query", "1.0"
						, mchId, outTradeNo, queryType);
		HttpUtil.getInstance(OrderDetailsActivity.this)
	...
	public void initData(PostOrderDetails entity){
		...
		pay_type_value.setText(""+entity.getPayChannelType());
	...
	public String changeDate(String datestring){
		...
		try {
			if (datestring != null) {
				...
				fatString = yearString+ "-"+ monString+"-"+dayString
						+" "+ hourString+":"+fentring+":"+miaoString;
			}
		} catch (Exception e) {
	...
	private Handler UIhandle = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				PostOrderDetails entity = ParaseJson.getInstance(OrderDetailsActivity.this)
						.ParasepostDetail(jsondata);
				initData(entity);
				break;
			case 2:
