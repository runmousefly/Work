...
public class OrderEntity {
	...
	public ExcraEntity getExtra() {
		return extra;
	}

	public void setExtra(ExcraEntity extra) {
		this.extra = extra;
	}
	...
	public void setTerminalType(String terminalTyp) {
		this.terminalType = terminalTyp;
	}
