package com.mct.serial.ranging;
...
public class RangingSerial
{
	
	private boolean mIsSerialOpen = false;
	private static final String TAG = "RangingSerial";
	...
	{
		Log.i(TAG, "init ranging mcu serial");
	...
	static
	{
		try
		{
			System.loadLibrary("ranging_serial");
		} catch (Exception e)
		{
			e.printStackTrace();
			Log.i(TAG, "load libranging_serial.so failed");
		}
	}
}
